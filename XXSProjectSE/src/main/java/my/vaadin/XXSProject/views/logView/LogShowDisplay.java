...
public class LogShowDisplay extends VerticalLayout {
	...
	public void showLogsForExersice(Exercise exerciseToShowLogsFor){
		...
		//Neue Logs anzeigen
			this.logsToShow = logProvider.getLogsForUsernameWorkoutPlanExercise(this.currentExercise.getFkUsername(), this.currentExercise.getFkWorkoutplanName(), this.currentExercise.getName());			
